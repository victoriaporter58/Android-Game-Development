...
// This package is not here by default it had to be imported to allow background audio
...
public class PlatformDemoScreen extends GameScreen {
    ...
    public PlatformDemoScreen(Game game) {
        ...
        for (int idx = 0; idx < numPlatforms; idx++) {
            ...
            //String to store the bitmapName generated from the Random selector
            String bitmapName = "";

            //Generate the pseudo-random integer
            int selectedPlatform = random.nextInt(3);

            //Determine what integer was generated and set the bitmapName accordingly
            switch(selectedPlatform) {
                case 0:
                    bitmapName = "Platform1";
                    break;
                case 1:
                    bitmapName = "Platform2";
                    break;
                case 2:
                    bitmapName = "Platform3";
                    break;
                default:
                    bitmapName = "Platform1";
                    break;
            ...
            //Pass bitmapName into the constructor
    ...
    // This is code that I have added, it allows the platform demo screen to play music when it is running
    // it currently uses the space demo audio had to import audio manager
    /**
